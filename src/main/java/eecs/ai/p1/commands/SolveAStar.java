...
public class SolveAStar extends Command {
    ...
    public final List<Directions> solveH2(Board currentBoard) {
        ...
        DISCOVERY: while (!discoveryQueue.isEmpty() /* && count != 0 */) {
            ...
            for (Directions move : nextMoves) {
                ...
                // System.out.println("Target consideration: " + move + " Has " +
                // currentState.peekNext(move));
    ...
    public final int heuristicTwo(BoardState state) {
        ...
        for (int i = 1; i < consideredState.size(); i++) {
            ...
            sumMoves += moveCount;
            // System.out.println("For: i = " + i + ", tile = " + consideredState.get(i) +
            // ", has now: " + sumMoves + "Moves");
